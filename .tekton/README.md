...
To modify the pipelines for `codeflare-operator` in the `rhoai-2.23-multi-arch-poc` release:
...
```bash
git commit -am "Update pipelinerun for codeflare-operator (rhoai-2.23-multi-arch-poc)"
